...
namespace THA_Week7_Valencia_E
{
    public partial class Film5 : Form
    {
        ...
        private void Film5_Load(object sender, EventArgs e)
        {
            ...
            Titanic.Location = new Point(20, 30);
            ...
            labelTitanic.Location = new Point(58, 175);
            this.Controls.Add(labelTitanic);

            Button btnJamFilm5 = new Button();
            btnJamFilm5.Text = "10.00";
            btnJamFilm5.Size = new Size(60, 30);
            btnJamFilm5.Location = new Point(190, 35);
            this.Controls.Add(btnJamFilm5);
            btnJamFilm5.Click += BtnJamFilm5_Click;

            Button btnJammFilm5 = new Button();
            btnJammFilm5.Text = "12.20";
            btnJammFilm5.Size = new Size(60, 30);
            btnJammFilm5.Location = new Point(190, 85);
            this.Controls.Add(btnJammFilm5);
            btnJammFilm5.Click += BtnJammFilm5_Click;

            Button btnJammmFilm5 = new Button();
            btnJammmFilm5.Text = "17.00";
            btnJammmFilm5.Size = new Size(60, 30);
            btnJammmFilm5.Location = new Point(190, 135);
            this.Controls.Add(btnJammmFilm5);
            btnJammmFilm5.Click += BtnJammmFilm5_Click;
            ...
            film5.Location = new Point(280, -4);
            film5.Name = "panel3";
            film5.Size = new Size(505, 505);
            film5.TabIndex = 0;
            this.Controls.Add(film5);
        ...
        int choose = 0;
        private void BtnJamFilm5_Click(object sender, EventArgs e)
        {
            ...
            {
                film5.Controls.Add(a);
                chooseseat.Text = "Selected Seat: ";
            }
        }
        private void BtnJammFilm5_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            film5.Controls.Clear();
            choose = 2;
        ...
        private void BtnJammmFilm5_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            film5.Controls.Clear();
            choose = 3;
