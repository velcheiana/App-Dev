...
namespace THA_Week7_Valencia_E
{
    public partial class Film6 : Form
    {
        ...
        private void Film6_Load(object sender, EventArgs e)
        {
            ...
            labelThor.Location = new Point(58, 175);
            this.Controls.Add(labelThor);

            Button btnJamFilm6 = new Button();
            btnJamFilm6.Text = "10.00";
            btnJamFilm6.Size = new Size(60, 30);
            btnJamFilm6.Location = new Point(190, 35);
            this.Controls.Add(btnJamFilm6);
            btnJamFilm6.Click += BtnJamFilm6_Click;

            Button btnJammFilm6 = new Button();
            btnJammFilm6.Text = "14.40";
            btnJammFilm6.Size = new Size(60, 30);
            btnJammFilm6.Location = new Point(190, 85);
            this.Controls.Add(btnJammFilm6);
            btnJammFilm6.Click += BtnJammFilm6_Click;

            Button btnJammmFilm6 = new Button();
            btnJammmFilm6.Text = "17.00";
            btnJammmFilm6.Size = new Size(60, 30);
            btnJammmFilm6.Location = new Point(190, 135);
            this.Controls.Add(btnJammmFilm6);
            btnJammmFilm6.Click += BtnJammmFilm6_Click;
            ...
            film6.Location = new Point(280, -4);
            film6.Name = "panel3";
            film6.Size = new Size(505, 505);
            film6.TabIndex = 0;
            this.Controls.Add(film6);
        ...
        int choose = 0;
        private void BtnJamFilm6_Click(object sender, EventArgs e)
        {
            ...
            {
                film6.Controls.Add(a);
                chooseseat.Text = "Selected Seat: ";
            }
        }

        private void BtnJammFilm6_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            film6.Controls.Clear();
            choose = 2;
        ...
        private void BtnJammmFilm6_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            film6.Controls.Clear();
            choose = 3;
