...
namespace THA_Week7_Valencia_E
{
    public partial class Film2 : Form
    {
        ...
        private void Film2_Load(object sender, EventArgs e)
        {
            ...
            Avatar.Location = new Point(20, 30);
            ...
            labelAvatar.Location = new Point(65, 175);
            this.Controls.Add(labelAvatar);

            Button btnJamFilm2 = new Button();
            btnJamFilm2.Text = "10.00";
            btnJamFilm2.Size = new Size(60, 30);
            btnJamFilm2.Location = new Point(190, 35);
            this.Controls.Add(btnJamFilm2);
            btnJamFilm2.Click += BtnJamFilm2_Click;

            Button btnJammFilm2 = new Button();
            btnJammFilm2.Text = "12.20";
            btnJammFilm2.Size = new Size(60, 30);
            btnJammFilm2.Location = new Point(190, 85);
            this.Controls.Add(btnJammFilm2);
            btnJammFilm2.Click += BtnJammFilm2_Click;

            Button btnJammmFilm2 = new Button();
            btnJammmFilm2.Text = "15.00";
            btnJammmFilm2.Size = new Size(60, 30);
            btnJammmFilm2.Location = new Point(190, 135);
            this.Controls.Add(btnJammmFilm2);
            btnJammmFilm2.Click += BtnJammmFilm2_Click;
            ...
            film2.Location = new Point(280, -4);
            film2.Name = "panel2";
            film2.Size = new Size(505, 505);
            film2.TabIndex = 0;
        ...
        int choose = 0;
        private void BtnJamFilm2_Click(object sender, EventArgs e)
        {
            ...
            {
                film2.Controls.Add(a);
                chooseseat.Text = "Selected Seat: ";
            }
        }
        private void BtnJammFilm2_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            film2.Controls.Clear();
            choose = 2;
        ...
        private void BtnJammmFilm2_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            film2.Controls.Clear();
            choose = 3;
